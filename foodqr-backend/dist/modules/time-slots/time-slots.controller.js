...
let TimeSlotsController = class TimeSlotsController {
    ...
    findByBranch(branchId) { return this.service.findByBranch(branchId); }
    upsert(branchId, body) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TimeSlotsController.prototype, "findByBranch", null);
__decorate([
    (0, common_1.Post)('branch/:branchId'),
    __param(0, (0, common_1.Param)('branchId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], TimeSlotsController.prototype, "upsert", null);
