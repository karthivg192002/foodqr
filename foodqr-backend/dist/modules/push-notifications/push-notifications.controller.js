...
let PushNotificationsController = class PushNotificationsController {
    ...
    findAll(userId, status, page, limit) {
...
], PushNotificationsController.prototype, "findAll", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PushNotificationsController.prototype, "send", null);
exports.PushNotificationsController = PushNotificationsController = __decorate([
    ...
    (0, common_1.Controller)('admin/push-notifications'),
