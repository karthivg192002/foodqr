      ...
      <header class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
        <div class="max-w-lg mx-auto px-4 h-14 flex items-center justify-between">
          <div class="flex items-center gap-2.5">
            <div class="w-8 h-8 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-sm">
              <span class="text-white text-xs font-extrabold tracking-tight">FQ</span>
            </div>
            <span class="font-extrabold text-gray-900 tracking-tight text-base">FoodQR</span>
          </div>
